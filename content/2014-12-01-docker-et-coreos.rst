...
Lors de ce 2e meetup de Toulouse DevOps, `Pierre Ozous <https://twitter.com/pierreozoux>`_ du projet `IndieHosters <http://indiehosters.net/>`_ viendra nous présenter leur environnement technique basé sur les dernières tendances en matière d'infrastructure: `CoreOS <http://coreos.com>`_ et `Docker <http://docker.io>`_.
